...
namespace Macro
{
    public class Regression : IList<PointD>
    {

        private List<PointD> _internalList = new List<PointD>();

        public Regression() : this(null, null) { }

        public Regression(IEnumerable<PointD> points)
        {
            ResetValues();
        ...
        public Regression(IEnumerable<double> Xs, IEnumerable<double> Ys)
        {
            ResetValues();
